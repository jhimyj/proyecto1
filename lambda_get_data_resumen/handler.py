...
BD_NAME = os.environ['SUMMARY_TABLE']#cambiae en deploy
...
def handler_function(event, context):
    ...
    try:
        ...
        response_service_bd = get_db_data(db_name=BD_NAME, user_id=sub_user, operation=name_operation)
